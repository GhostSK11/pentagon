...
GRAPH_WIDTH = 150       # each individual graph size in pixels
GRAPH_HEIGHT = 120
...
def main():
    ...
    layout = [[ sg.Text('CPU Usage Monitor')]]
                #sg.Text('CPU Usage Monitor')] ]
    ...
    # ----------------  Create Window  ----------------
    window = sg.Window('CPU Usage Monitor', layout,
                       #keep_on_top=true,
